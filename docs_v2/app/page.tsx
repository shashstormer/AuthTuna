            ...
            <div className="flex flex-col items-center text-center px-6 pt-20 pb-16">
                <div className="mb-8">
                    <h1 className={"flex mb-4"}>
                        <span className="text-7xl md:text-9xl animate-bounce">🐟</span><span className={"text-6xl md:text-8xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent"}>AuthTuna</span>
                    </h1>
                    <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 animate-pulse">
                ...
                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                    ...
                    <a
                        ...
                        className="border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-300 hover:scale-105 hover:shadow-lg"
                    >
                        View on GitHub
                    </a>
                </div>

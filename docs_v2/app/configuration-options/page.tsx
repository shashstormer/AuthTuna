  ...
  return (
    <div className="max-w-[90vw] md:max-w-6xl mx-auto px-4 md:px-6 py-8 pt-16 md:pt-20">
      ...
      <p className="text-base md:text-lg text-gray-700 dark:text-gray-300 mb-8">
        AuthTuna uses Pydantic settings to manage configuration. All settings can be overridden via environment variables or programmatically. Below is a comprehensive table of all available settings, followed by detailed sections for each category.
      </p>

      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">All Settings Overview</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full table-auto border-collapse border border-gray-300 dark:border-gray-600">
            <thead>
              <tr className="bg-gray-100 dark:bg-gray-800">
                <th className="border border-gray-300 dark:border-gray-600 px-4 py-2 text-left">Setting Name</th>
                <th className="border border-gray-300 dark:border-gray-600 px-4 py-2 text-left">Default Value</th>
            ...
            <tbody>
              ...
              <tr className="bg-gray-50 dark:bg-gray-700">
                ...
                <td className="border border-gray-300 dark:border-gray-600 px-4 py-2">{`Key at index 0 is primary key`}</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="border border-gray-300 dark:border-gray-600 px-4 py-2">{`Dosent need change usually.`}</td>
              </tr>
              <tr className="bg-gray-50 dark:bg-gray-700">
      ...
      <section className="mb-6 md:mb-8">
        <h2 className="text-xl md:text-2xl font-semibold text-gray-900 dark:text-white mb-4">Setting Configuration Options</h2>
        ...
        <p className="text-base md:text-lg text-gray-700 dark:text-gray-300 mb-4">
          Create a <code className="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">.env</code> file in your project root:
        </p>
        <CodeBlock
          code={`# .env
API_BASE_URL=https://yourapp.com
JWT_SECRET_KEY=your-secure-jwt-secret
ENCRYPTION_PRIMARY_KEY=your-encryption-key
MFA_ENABLED=true
